...
import consulo.ide.impl.idea.openapi.vcs.changes.VcsDirtyScopeManagerImpl;
import consulo.ide.impl.idea.openapi.vcs.changes.VcsDirtyScopeVfsListener;
...
public abstract class SvnTestDirtyScopeStateTest extends Svn17TestCase {
  ...
  public void testWhatIsDirty() throws Exception {
    ...
    final List<FilePath> list = consulo.ide.impl.idea.openapi.vcs.ObjectsConvertor.vf2fp(Arrays.asList(file, fileB, fileC, fileD));
