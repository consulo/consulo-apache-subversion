...
public abstract class SvnAuthenticationTest extends PlatformTestCase
{
	...
	private static boolean passwordSpecified(final SVNAuthentication authentication)
	{
		...
		if(ISVNAuthenticationManager.SSH.equals(kind))
		{
			...
			{
				return ((SVNSSHAuthentication) authentication).getPassphrase() != null && (((SVNSSHAuthentication) authentication).getPrivateKey() != null || ((SVNSSHAuthentication) authentication)
